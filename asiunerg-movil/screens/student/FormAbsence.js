...
import { matterToAbsencesAction, reportAbsenceAction } from '../../store/actions/student/AbsenceActions';
...
function FormAbsenceStudent() {
	...
	useEffect(() => {
		setLoading(studentAbsences.loading)
	}, [studentAbsences.loading])
...
export default FormAbsenceStudent;