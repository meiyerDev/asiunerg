...
class ResponseFormAbsence extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        foreach ($this->resource as $absence) {
            $absences[] = [
                'id' => $absence->id,
                'code' => $absence->absence->inscription->section->matter->codigo,
                'name' => $absence->absence->inscription->section->matter->nombre,
                'name_avr' => $absence->absence->inscription->section->matter->avr,
                'section' => $absence->absence->inscription->section->nombre,
