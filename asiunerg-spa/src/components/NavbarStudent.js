            ...
            >
              ...
              <Nav className="navbar-nav-hover align-items-lg-center" navbar>
                ...
                <UncontrolledDropdown nav>
                  ...
                  <DropdownMenu>
                    <DropdownItem to="/estudiante/inasistencias/nueva" tag={Link}>
                      Informar Nueva
                    </DropdownItem>
                    <DropdownItem to="/estudiante/inasistencias" tag={Link}>
                      Mis Inasistencias
                    </DropdownItem>
                    <DropdownItem to="/estudiante/inasistencias/profesor" tag={Link}>
                      Profesores
                    </DropdownItem>
                  </DropdownMenu>
                </UncontrolledDropdown>
                <NavItem>
                  <NavLink tag={Link} to="/estudiante/clases">
                    Clases
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink tag={Link} to="/estudiante/perfil">
                    Perfil
                  </NavLink>
                </NavItem>
              </Nav>
                ...
                <NavItem className="d-none d-lg-block ml-lg-4">
                  ...
                  >
                    ...
                    <span className="nav-link-inner--text ml-1">
                      { isLoading ? 'Espere..' : 'Cerrar Sesión' }
                    </span>
                  </Button>
                </NavItem>
